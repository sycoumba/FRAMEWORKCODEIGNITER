...
<header>
    ...
    <p>OUVERTURE COMPTE CLIENT NON SALARIE</p>
 <div class="container">
    <br>
    ...
    <div class="row">
      <div class="col-md-9">
      <form action="<?php echo base_url('public/index.php/ClientNonSalarie/store');?>" name="clientnonsalarie_create" id="clientnonsalarie_create" method="post" accept-charset="utf-8">
          ...
          <div class="form-group">
            ...
            <input type="text" name="activite" class="form-control" id="activite" placeholder="Veuillez entrer l'activite">
 ...
 <script>
   if ($("#clientnonsalarie_create").length > 0) {
      $("#clientnonsalarie_create").validate({
