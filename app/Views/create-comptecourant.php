...
<header>
 ...
 <div class="container">
    ...
    <div class="row">
      <div class="col-md-9">
      <form action="<?php echo base_url('public/index.php/CompteCourant/store');?>" name="comptecourant_create" id="comptecourant_create" method="post" accept-charset="utf-8">
          ...
          <div class="form-group">
            ...
            <input type="text" name="agios" class="form-control" id="agios" placeholder="Veuillez entrer l'agios">
          </div> 
